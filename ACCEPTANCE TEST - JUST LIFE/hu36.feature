Feature: HU36: Como paciente. quiero registrar mi ubicación para que la aplicación recomiende rutinas de ejercicios ideales en mi zona.
    ...
    Scenario: 02: Denegar permisos a la aplicaciòn
        ...
        Then la aplicación se mostrará un formulario donde ingresaré mi dirección  
